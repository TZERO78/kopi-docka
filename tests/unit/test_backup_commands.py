...
class TestListCommand:
    ...
    def test_list_units_only(
        ...
        result = cli_runner.invoke(
            app, 
            ["list", "--units", "--config", str(tmp_config)]
        )
    ...
    def test_list_snapshots_only(
        ...
        result = cli_runner.invoke(
            app,
            ["list", "--no-units", "--snapshots", "--config", str(tmp_config)]
        )
...
class TestBackupCommand:
    ...
    def test_backup_specific_unit(
        ...
        result = cli_runner.invoke(
            app,
            ["backup", "--unit", "test-unit", "--config", str(tmp_config)]
        )
    ...
    def test_backup_dry_run(
        ...
        result = cli_runner.invoke(
            app,
            ["backup", "--dry-run", "--config", str(tmp_config)]
        )
